...
export async function run(provider: NetworkProvider) {
    ...
    const addresses: [ Address, Address, Address, Address, Address, Address ] = await orderBook.getAddresses()
    console.log("[ owner_address ]:", addresses[0])
    console.log("[ admin_address ]:", addresses[1])
    console.log("[ book_minter_address ]:", addresses[2])
    console.log("[ soxo_jetton_address ]:", addresses[3])
    console.log("[ usdt_jetton_wallet ]:", addresses[4])
    console.log("[ soxo_jetton_wallet ]:", addresses[5])
}
